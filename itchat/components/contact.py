...
def load_contact(core):
    ...
    core.get_cookies                 = get_cookies                  # guanyue added
...
# webwxgetcontact?r=1552898757457&seq=0&skey=@crypt_8909546a_46941b4c4a81b9990352742923a95d6e
...
def get_head_img(self, userName=None, chatroomUserName=None, picDir=None):
    ...
    print("request[url={1}]\nresponse[headers={0}]".format(r.headers,url))
